...
function App() {
  ...
  const handleManualSubmit = (e) => {
    ...
    if (normalizedId.length === 17 && normalizedId.startsWith('7656')) {
      ...
      setManualError('Invalid Steam64 ID. Please enter the 17-digit number starting with 7656.');
    }
  };
      ...
      {steamId ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen text-white p-6">
          <div className="max-w-md w-full text-center">
            ...
            <p className="text-slate-400 mb-10 font-medium">A random game picker for your Steam library.</p>
            ...
            >
              <img src="/steam-logo.png" alt="Steam" className="h-6" />
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-slate-500 text-xs font-black tracking-[0.3em] uppercase">OR</span>
              <div className="flex-1 h-px bg-slate-800"></div>
            </div>
            ...
            <form onSubmit={handleManualSubmit} className="space-y-3">
              ...
              {manualError ? (
                <p className="text-sm text-red-400 text-left" role="alert">{manualError}</p>
              ) : null}
              <button 
                type="submit"
            ...
            <div className="mt-8 space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed uppercase tracking-wider">
                Note: Your game library must be set to "Public" in Steam privacy settings.
              </p>
            </div>
          </div>
        </div>
